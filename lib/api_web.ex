defmodule ReviewAppWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ReviewAppWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ReviewAppWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import ReviewAppWeb.ErrorHelpers
      import ReviewAppWeb.Gettext
      alias ReviewAppWeb.Router.Helpers, as: Routes
    end
  end
